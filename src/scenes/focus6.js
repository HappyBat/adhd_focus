...
export default class Focus6 extends Focus_scene {
  ...
  btn1_create() {
    ...
    this.angryBoss = this.add.image(1190, 430, "angryBoss").setScale(2).setDepth(1400);
  }
  createNames() {
    ...
    for (var i = 0; i < sortingArray.length; i++) {
      ...
      sortingArray[i].on("dragend", function () {
        ...
        if (this.x < x1 && this.y < y1) {
          this.x = 317;
          this.y = 90;
        } else if (this.x < x1 && this.y > y1 && this.y < y2) {
          this.x = 317;
          this.y = 90 + 75;
        } else if (this.x < x1 && this.y > y2 && this.y < y3) {
          this.x = 317;
          this.y = 90 + 2 * 75;
        } else if (this.x < x1 && this.y > y3 && this.y < y4) {
          this.x = 317;
          this.y = 90 + 3 * 75;
        } else if (this.x < x1 && this.y > y4 && this.y < y5) {
          this.x = 317;
          this.y = 90 + 4 * 75;
        } else if (this.x < x1 && this.y > y5 && this.y < y6) {
          this.x = 317;
          this.y = 90 + 5 * 75;
